...
public class Solution {
    ...
    public static class Gamer extends Thread {
        ...
        public void run() {
            /*Требования:
            1. Метод run класса Gamer через равные интервалы времени (1000ms / rating) должен выводить в консоль фамилию игрока (метод getName()), потом двоеточие,
            ...
            for (String step:OnlineGame.steps){
                ...
                try {
                    if (OnlineGame.isWinnerFound){System.out.println(getName() + ":проиграл");
                        return;}
            ...
            if (!OnlineGame.isWinnerFound){OnlineGame.isWinnerFound = true;}
