       ...
       /*name - имя, String
        ...
        switch (value) {
            case "-c":
                ...
                name = args[1];
                male = args[2].equals("м") ? Sex.MALE : Sex.FEMALE;

                try {
                    date = formatter.parse(args[3]);//создаю дату через
            ...
            case "-u":
                ...
                name = args[2];
                male = args[3].equals("м") ? Sex.MALE : Sex.FEMALE;

                try {
                    date = formatter.parse(args[4]);//создаю дату через
                } catch (ParseException e) {
                    e.printStackTrace();
                }
